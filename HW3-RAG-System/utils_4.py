...
def get_inference_user_prompt(query : str, context_list : List[str]) -> str:
    ...
    prompt = f"""Context Information:\n{context_text}\nQuestion: {query}\n\nInstructions: 1. Copy the exact answer phrase directly from the passages above. 2. Do NOT paraphrase, expand, or add explanations. 3. If the answer is not in the context, output exactly: \"CANNOTANSWER\". 4. Your answer must be one continuous text span or CANNOTANSWER. \n\nExample:\nPassage: "The album gained critical acclaim and achieved gold status." \n Query: "Was the album successful?"\nCORRECT: "The album gained critical acclaim and achieved gold status." \n WRONG: "Yes, it was a massive critical and commercial success." \n WRONG: "The album, released in 1988, was critically acclaimed."
\n\nAnswer:"""
    return prompt
